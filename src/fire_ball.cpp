...
#include "../generated.h"
#include "fire_ball.ufo.h"

FireBall::FireBall(Vector2f _) : custom::PlatformerRectangleCollision(_){}

void FireBall::OnSpawn(){
...
void FireBall::OnUpdate(float _delta_time){
