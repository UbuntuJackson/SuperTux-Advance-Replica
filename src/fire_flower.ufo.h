...
ufo_actor_config("src/fire_flower.ason")
ufo_category("STA-Replica")
class FireFlower : public custom::PlatformerRectangleCollision{
public:

    const std::string SOLID = "res/gfx/solid.png";

    FireFlower(Vector2f _) : custom::PlatformerRectangleCollision(_){}
